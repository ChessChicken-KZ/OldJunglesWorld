...
public class TreeTaiga3 extends Structure {
                ...
                if ((l1 ==  BlockBase.GRASS.id || l1 ==  BlockBase.DIRT.id) && j < 128 - l - 1) {
                        ...
                        for(l4 = i - k2; l4 <= i + k2; ++l4) {
                            ...
                            for(int k5 = k - k2; k5 <= k + k2; ++k5) {
                                ...
                                if ((Math.abs(j5) != k2 || Math.abs(l5) != k2 || k2 <= 0) && !BlockBase.FULL_OPAQUE[world.getTileId(l4, j4, k5)]) {
                                    ...
                                    world.setTileWithMetadata(l4 - 1, j4, k5, BlockBase.LEAVES.id, 1);
                                    world.setTileWithMetadata(l4, j4, k5 - 1, BlockBase.LEAVES.id, 1);
                                    world.setTileWithMetadata(l4 - 1, j4, k5 - 1, BlockBase.LEAVES.id, 1);
                                }
                            }
                        }
                    ...
                    for(j4 = 0; j4 < l - k3; ++j4) {
                        ...
                        if (l4 == 0 || l4 == BlockBase.LEAVES.id) {
                            ...
                            world.setTileWithMetadata(i - 1, j + j4, k, BlockBase.LOG.id, 1);
                            world.setTileWithMetadata(i, j + j4, k - 1, BlockBase.LOG.id, 1);
                            world.setTileWithMetadata(i - 1, j + j4, k - 1, BlockBase.LOG.id, 1);
                        }
                    }
